...
class image__:
    ...
    def icons(name, dimension=()):
        ...
        # Control
        elif name == "add_new": return ImageTk.PhotoImage(tab_button_icon(icon = Image.open("./res/icons/control/plus.png").resize((250,250),Image.LANCZOS), text = "ADD TASK", text_bg  = "#cecfc6", img_width  = 200-30, img_original_height  =32, diff_icon_text  = 0, place_icon = "right",rounded=True,round_bg='#242437').resize((dimension if len(dimension) == 2 else (138, 32)), Image.LANCZOS))
        elif name == "add_new_hover": return ImageTk.PhotoImage(tab_button_icon(icon = Image.open("./res/icons/control/plus.png").resize((250,250),Image.LANCZOS), text = "ADD TASK", text_bg  = "#e5e6dc", img_width  = 200-30, img_original_height  =32, diff_icon_text  = 0, place_icon = "right",rounded=True,round_bg='#242437').resize((dimension if len(dimension) == 2 else (138, 32)), Image.LANCZOS))

        elif name == "add_new_billing": return ImageTk.PhotoImage(tab_button_icon(icon = Image.open("./res/icons/control/plus.png").resize((250,250),Image.LANCZOS), text = "ADD KEYS", text_bg  = "#cecfc6", img_width  = 200-30, img_original_height  =32, diff_icon_text  = 0, place_icon = "right",rounded=True,round_bg='#242437').resize((dimension if len(dimension) == 2 else (138, 32)), Image.LANCZOS))
        elif name == "add_new_billing_hover": return ImageTk.PhotoImage(tab_button_icon(icon = Image.open("./res/icons/control/plus.png").resize((250,250),Image.LANCZOS), text = "ADD KEYS", text_bg  = "#e5e6dc", img_width  = 200-30, img_original_height  =32, diff_icon_text  = 0, place_icon = "right",rounded=True,round_bg='#242437').resize((dimension if len(dimension) == 2 else (138, 32)), Image.LANCZOS))

        elif name == "add_new_proxy": return ImageTk.PhotoImage(tab_button_icon(icon = Image.open("./res/icons/control/plus.png").resize((250,250),Image.LANCZOS), text = "ADD PROXY", text_bg  = "#cecfc6", img_width  = 200-30, img_original_height  =32, diff_icon_text  = 0, place_icon = "right",rounded=True,round_bg='#242437').resize((dimension if len(dimension) == 2 else (138, 32)), Image.LANCZOS))
        elif name == "add_new_proxy_hover": return ImageTk.PhotoImage(tab_button_icon(icon = Image.open("./res/icons/control/plus.png").resize((250,250),Image.LANCZOS), text = "ADD PROXY", text_bg  = "#e5e6dc", img_width  = 200-30, img_original_height  =32, diff_icon_text  = 0, place_icon = "right",rounded=True,round_bg='#242437').resize((dimension if len(dimension) == 2 else (138, 32)), Image.LANCZOS))

        elif name == "add_new_capture": return ImageTk.PhotoImage(tab_button_icon(icon = Image.open("./res/icons/control/plus.png").resize((250,250),Image.LANCZOS), text = "GET BALANCE", text_bg  = "#cecfc6", img_width  = 200-30, img_original_height  =32, diff_icon_text  = 0, place_icon = "right",rounded=True,round_bg='#242437').resize((dimension if len(dimension) == 2 else (138, 32)), Image.LANCZOS))
        elif name == "add_new_capture_hover": return ImageTk.PhotoImage(tab_button_icon(icon = Image.open("./res/icons/control/plus.png").resize((250,250),Image.LANCZOS), text = "GET BALANCE", text_bg  = "#e5e6dc", img_width  = 200-30, img_original_height  =32, diff_icon_text  = 0, place_icon = "right",rounded=True,round_bg='#242437').resize((dimension if len(dimension) == 2 else (138, 32)), Image.LANCZOS))
